...
export function SpeechToText({ apiKey,mic_bg_color, SpeechRecognition, resetTranscript, browserSupportsSpeechRecognition, transcript, setJsonStoredData,mic_color }: SpeechToTextProps) {
